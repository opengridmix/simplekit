package org.thrive.site.core.util;

import net.sf.ehcache.Cache;
import net.sf.ehcache.CacheManager;
import net.sf.ehcache.Element;
import org.thrive.site.core.config.Constants;
...
public class SqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		LoggerUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSql(String methodUrl) {
		...
		else if(Constants.MODE_PRODUCT.equals(bundle.getObject("sqlReadMode"))){
...
//		返回读取指定资源的输入流   
        InputStream is = SqlUtil.class.getResourceAsStream(sqlurl);
	...
	public static String getAppPath(Class cls) {
		...
		LoggerUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		LoggerUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
	}
