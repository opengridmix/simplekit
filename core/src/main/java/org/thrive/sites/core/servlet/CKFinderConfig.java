 ...
 */
package org.thrive.sites.core.servlet;
...
import org.thrive.sites.core.util.FileUtil;
...
public class CKFinderConfig extends Configuration {
    ...
    protected Configuration createConfigurationInstance() {
		Principal principal = (Principal) UserUtil.getPrincipal();
		if (principal == null){
...
//			this.baseURL = ServletContextFactory.getServletContext().getContextPath()+"/userfiles/"+principal+"/";
			this.baseURL = FileUtil.path(Servlets.getRequest().getContextPath() + Global.USERFILES_BASE_URL + principal + "/");
			this.baseDir = FileUtil.path(Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL + principal + "/");
		} catch (Exception e) {
    ...
    public boolean checkAuthentication(final HttpServletRequest request) {
        return UserUtil.getPrincipal()!=null;
    }
