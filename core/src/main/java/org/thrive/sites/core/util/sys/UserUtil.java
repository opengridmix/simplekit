 ...
 */
package org.thrive.sites.core.util.sys;
...
import org.thrive.sites.core.persistence.dao.sys.*;
import org.thrive.sites.core.persistence.entity.sys.*;
...
public class UserUtil {
    ...
    public static void clearCache(User user) {
        ...
        if (user.getOffice() != null && user.getOffice().getId() != null) {
            CacheUtil.remove(USER_CACHE, USER_CACHE_LIST_BY_OFFICE_ID_ + user.getOffice().getId());
        }
    }
...
//		systemRealm.clearAllCachedAuthorizationInfo();
     ...
     * find role for user.
     */
    public static List<Role> findRole(Role role){
     ...
     *}]
     */
    public static List<Menu> getMenuChildren(String parentId) {
        @SuppressWarnings("unchecked")
        List<Menu> partialmenu = (List<Menu>) getCache(CACHE_MENU_LIST + parentId);
        if (partialmenu == null) {
            List<Menu> menuList = getMenuList();
            Menu parent = null;
            for (Menu e : menuList) {
                String mid = e.getId();
                boolean matched = mid.equals(parentId);
                if (matched) {
                    parent = e;
                    Menu.toTree(parent, menuList, true);
                    partialmenu = parent.getChildren();
                    putCache(CACHE_MENU_LIST + parentId, partialmenu);
                    break;
                }
            }
        }
