package org.thrive.sites.core.exception;

import org.apache.log4j.Logger;
import org.springframework.stereotype.Component;
import org.springframework.web.servlet.HandlerExceptionResolver;
import org.springframework.web.servlet.ModelAndView;
import org.thrive.sites.core.util.oConvertUtil;
...
public class GlobalExceptionResolver implements HandlerExceptionResolver {
	...
	private boolean isAjax(HttpServletRequest request, HttpServletResponse response){
		return oConvertUtil.isNotEmpty(request.getHeader("X-Requested-With"));
	}
	/**
	...
	private void logDb(Throwable ex) {
		...
		if(oConvertUtil.isNotEmpty(exceptionMessage)){
