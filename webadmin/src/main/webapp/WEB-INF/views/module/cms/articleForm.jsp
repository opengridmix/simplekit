...
<body>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
        ...
        <div id="linkBody" class="form-group" style="display:none">
            <label class="control-label col-sm-1">外部链接:</label>
            <div class="col-md-4">
		...
		<div class="form-group">
			<label class="control-label col-sm-1">相关文章:</label>
			<div class="col-md-4">
		...
		<shiro:hasPermission name="cms:category:edit">
            <div class="form-group">
                ...
                <div class="col-md-4">
                      <form:select path="customContentView" class="">
		...
		<c:if test="${not empty article.id}">
			<div class="form-group">
				<label class="control-label col-sm-1">查看评论:</label>
				<div class="col-md-4">
