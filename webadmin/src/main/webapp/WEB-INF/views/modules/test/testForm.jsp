...
<body>
	...
	<form:form id="inputForm" modelAttribute="test" action="${ctx}/test/test/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<a class="btn" href="${ctxStatic}/MUI/plugins/bootstrap/3.3.6/docs/index.html">Bootstrap</a>
				<a class="btn" href="http://ivaynberg.github.io/select2/">多功能下拉框组件</a>
				<a class="btn" href="${ctxStatic}/MUI/plugins/jquery-ztree/3.5.12/demo/cn/index.html">树结构组件</a>
				<input class="btn" type="button" value="对话框" onclick="top.$.jBox('iframe:${ctxStatic}/MUI/plugins/jquery-jbox/2.3/docs/jbox-demo.html',{title: '对话框',width: 950,height: 600,buttons: { '关闭': true }});"/>
				<input class="btn" type="button" value="客户端验证" onclick="top.$.jBox('iframe:${ctxStatic}/MUI/plugins/jquery-validation/1.11.0/demo/index.html',{title: '客户端验证',width: 950,height: 600,buttons: { '关闭': true }});"/>
			</div>
		</div>
