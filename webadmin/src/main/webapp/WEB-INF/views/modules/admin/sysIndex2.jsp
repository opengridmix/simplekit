...
<head>
    ...
    <c:if test="${cookie.tabmode.value eq '1'}"><link rel="Stylesheet" href="${ctxStatic}/MUI/plugins/jerichotab/css/jquery.jerichotab.css" />
			...
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right"><%--
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="${ctx}/admin/user/info" target="mainFrame"><i class="fa fa-user"></i>&nbsp; 个人信息</a></li>
							<li><a href="${ctx}/admin/user/modifyPwd" target="mainFrame"><i class="fa fa-lock"></i>&nbsp;  修改密码</a></li>
							...
							<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
								<li class="menu ${not empty firstMenu && firstMenu ? ' active' : ''}">
									<c:if test="${empty menu.href}">
										<a class="menu" href="javascript:" data-href="${ctx}/admin/menu/tree?parentId=${menu.id}" data-id="${menu.id}"><span>${menu.name}</span></a>
									</c:if>
