...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/admin/role/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label col-sm-1">角色类型:</label>
			<div class="col-md-4"><%--
				...
				<form:select path="roleType" class="">
		...
		<div class="form-group">
			<label class="control-label col-sm-1">是否系统数据:</label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label class="control-label col-sm-1">数据范围:</label>
			<div class="col-md-4">
				<form:select path="dataScope" class="">
		...
		<div class="form-group">
			<label class="control-label col-sm-1">角色授权:</label>
			<div class="col-md-4">
