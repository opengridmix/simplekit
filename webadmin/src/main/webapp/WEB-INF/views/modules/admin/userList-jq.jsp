...
<body>
	...
	<link href="${ctxStatic}/MUI/plugins/jqGrid/4.6/css/ui.jqgrid.css" type="text/css" rel="stylesheet" />
	<script src="${ctxStatic}/MUI/plugins/jqGrid/4.7/js/jquery.jqGrid.js" type="text/javascript"></script>
	<script src="${ctxStatic}/MUI/plugins/jqGrid/4.7/js/jquery.jqGrid.extend.js" type="text/javascript"></script>
	<script type="text/javascript">
		// 初始化DataGrid对象
		$('#dataGrid').dataGrid({
