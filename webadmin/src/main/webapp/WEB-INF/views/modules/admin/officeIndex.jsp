...
<body>
	...
	<div id="content" class="row">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/admin/office/list?id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	<script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#officeContent').attr("src","${ctx}/admin/office/list?id="+id+"&parentIds="+treeNode.pIds);
				}
			}
		};
