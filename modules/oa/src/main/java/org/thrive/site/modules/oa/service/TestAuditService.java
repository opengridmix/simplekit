...
import org.thrive.site.modules.oa.dao.TestAuditDao;
...
import org.thrive.site.modules.act.service.ActTaskService;
import org.thrive.site.modules.act.util.ActUtil;
import org.thrive.site.modules.oa.entity.TestAudit;
...
public class TestAuditService extends CrudService<TestAuditDao, TestAudit> {
	...
	public void save(TestAudit testAudit) {
		...
		if (StringUtil.isBlank(testAudit.getId())){
			...
			// 启动流程
			actTaskService.startProcess(ActUtil.PD_TEST_AUDIT[0], ActUtil.PD_TEST_AUDIT[1], testAudit.getId(), testAudit.getContent());
