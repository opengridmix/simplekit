 ...
 */
package org.thrive.site.modules.gen.util;
...
import org.thrive.site.modules.gen.entity.*;
import org.thrive.site.core.config.Global;
import org.thrive.site.core.mapper.JaxbMapper;
...
import org.thrive.site.core.util.FreeMarkers;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("functionAuthor", StringUtil.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor(): UserUtil.getUser().getName());
