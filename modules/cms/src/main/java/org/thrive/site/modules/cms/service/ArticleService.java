 ...
 */
package org.thrive.site.modules.cms.service;

import com.google.common.collect.Lists;
import org.apache.commons.lang3.StringEscapeUtils;
import org.thrive.site.modules.cms.dao.ArticleDao;
import org.thrive.site.modules.cms.dao.CategoryDao;
...
import org.thrive.site.modules.cms.dao.ArticleDataDao;
...
public class ArticleService extends CrudService<ArticleDao, Article> {
	...
	public Page<Article> findPage(Page<Article> page, Article article, boolean isDataScopeFilter) {
		// 更新过期的权重，间隔为“6”个小时
		Date updateExpiredWeightDate =  (Date)CacheUtil.get("updateExpiredWeightDateByArticle");
		if (updateExpiredWeightDate == null || (updateExpiredWeightDate != null 
				&& updateExpiredWeightDate.getTime() < new Date().getTime())){
			dao.updateExpiredWeight(article);
			CacheUtil.put("updateExpiredWeightDateByArticle", DateUtil.addHours(new Date(), 6));
		}
...
//		return dao.find(page, dc);
	...
	public void save(Article article) {
		...
		article.setUpdateBy(UserUtil.getUser());
