 ...
 */
package org.thrive.site.modules.cms.util;

import com.google.common.collect.Lists;
import org.thrive.site.modules.cms.entity.Category;
import org.thrive.site.modules.cms.entity.Site;
import org.thrive.site.modules.cms.service.ArticleService;
import org.thrive.site.modules.cms.service.CategoryService;
import org.thrive.site.modules.cms.service.LinkService;
import org.thrive.site.core.config.Global;
import org.thrive.site.core.mapper.JsonMapper;
import org.thrive.site.core.persistence.Page;
import org.thrive.site.core.util.CacheUtil;
import org.thrive.site.core.util.SpringContextHolder;
import org.thrive.site.core.util.StringUtil;
import org.thrive.site.modules.cms.entity.Article;
import org.thrive.site.modules.cms.entity.Link;
import org.thrive.site.modules.cms.service.SiteService;
...
public class CmsUtil {
	...
	public static List<Site> getSiteList(){
		...
		List<Site> siteList = (List<Site>)CacheUtil.get(CMS_CACHE, "siteList");
		if (siteList == null){
			Page<Site> page = new Page<Site>(1, -1);
			page = siteService.findPage(page, new Site());
			siteList = page.getList();
			CacheUtil.put(CMS_CACHE, "siteList", siteList);
		}
		return siteList;
	}
	...
	public static List<Category> getMainNavList(String siteId){
		@SuppressWarnings("unchecked")
		List<Category> mainNavList = (List<Category>)CacheUtil.get(CMS_CACHE, "mainNavList_"+siteId);
		if (mainNavList == null){
			...
			CacheUtil.put(CMS_CACHE, "mainNavList_"+siteId, mainNavList);
		}
		return mainNavList;
	}
	...
	public static Object getCache(String key) {
		return CacheUtil.get(CMS_CACHE, key);
	}

	public static void putCache(String key, Object value) {
		CacheUtil.put(CMS_CACHE, key, value);
	}

	public static void removeCache(String key) {
		CacheUtil.remove(CMS_CACHE, key);
	}
