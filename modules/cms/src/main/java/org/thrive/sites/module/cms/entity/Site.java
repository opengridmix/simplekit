 ...
 */
package org.thrive.sites.module.cms.entity;

import org.hibernate.validator.constraints.Length;
import org.thrive.sites.core.persistence.entity.DataEntity;
...
public class Site extends DataEntity<Site> {
	...
	public static String getCurrentSiteId(){
		String siteId = (String) UserUtil.getCache("siteId");
		return StringUtil.isNotBlank(siteId)?siteId:defaultSiteId();
	}

    /**
   	 * 模板路径
   	 */
   	public static final String TPL_BASE = "/WEB-INF/views/module/cms/front/themes";

    /**
   	 * 获得模板方案路径。如：/WEB-INF/views/module/cms/front/themes/jeesite
   	 *
   	 * @return
   	 */
