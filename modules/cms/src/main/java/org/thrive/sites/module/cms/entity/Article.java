...
public class Article extends DataEntity<Article> {
	...
	public void setImage(String image) {
        this.image = image;//CmsUtil.formatImageSrcToDb(image);
	}
	...
	public List<String> getPosidList() {
		...
		if (posid != null){
			for (String s : StringUtil.split(posid, ",")) {
				list.add(s);
			}
		}
		return list;
	...
	public void setPosidList(List<String> list) {
   	...
   	public String getImageSrc() {
        return CmsUtil.formatImageSrcToWeb(this.image);
   	}
