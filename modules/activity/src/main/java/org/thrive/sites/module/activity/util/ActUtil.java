 ...
 */
package org.thrive.sites.module.activity.util;
...
import org.thrive.sites.core.annotation.FieldName;
			...
			for (Method m : entity.getClass().getMethods()){
				if (m.getAnnotation(JsonIgnore.class) == null && m.getAnnotation(JsonBackReference.class) == null && m.getName().startsWith("get")){
					...
					if (m.getName().equals("getAct")){
						...
						map.put("taskId", java.util.Objects.toString(m.invoke(act, new Object[]{}), ""));
					}else{
						field.add(StringUtil.uncapitalize(m.getName().substring(3)));
						value.add(java.util.Objects.toString(m.invoke(entity, new Object[]{}), ""));
					}
				}
			}
		}catch (Exception e) {
