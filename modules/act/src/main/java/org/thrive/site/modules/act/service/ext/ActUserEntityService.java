 ...
 */
package org.thrive.site.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			UserUtil.deleteUser(new org.thrive.site.core.persistence.entity.sys.User(user.getId()));
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : UserUtil.findRole(new Role(new org.thrive.site.core.persistence.entity.sys.User(null, userId)))){
