...
import org.thrive.sites.core.beanvalidator.BeanValidators;
...
import org.thrive.sites.core.util.excel.ExportExcel;
import org.thrive.sites.core.util.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String modifyPwd(String oldPassword, String newPassword, Model model) {
		...
		if (StringUtil.isNotBlank(oldPassword) && StringUtil.isNotBlank(newPassword)){
			if(Global.isDemoMode()){
				model.addAttribute("message", "演示模式，不允许操作！");
				return "module/sys/userModifyPwd";
			}
