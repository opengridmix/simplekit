 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/admin/office")
...
//        model.addAttribute("list", officeService.findAll());
		return "modules/admin/officeIndex";
	}
	...
	public String list(Office office, Model model) {
		...
		return "modules/admin/officeList";
	}
	...
	public String form(Office office, Model model) {
		...
		return "modules/admin/officeForm";
	}
	...
	public String save(Office office, Model model, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			...
			return "redirect:" + adminPath + "/admin/office/";
		}
		...
		if(office.getChildDeptList()!=null){
			...
			for(String id : office.getChildDeptList()){
				...
				childOffice.setName(DictUtil.getDictLabel(id, "sys_office_common", "未知"));
		...
		return "redirect:" + adminPath + "/admin/office/list?id="+id+"&parentIds="+office.getParentIds();
	}
	...
	public String delete(Office office, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/admin/office/list";
		}
//		if (Office.isRoot(id)){
...
//		}
		return "redirect:" + adminPath + "/admin/office/list?id="+office.getParentId()+"&parentIds="+office.getParentIds();
	}
