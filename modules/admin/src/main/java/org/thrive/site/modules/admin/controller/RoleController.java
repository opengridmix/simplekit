...
import org.thrive.site.modules.admin.service.OfficeService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/admin/role")
public class RoleController extends BaseController {
	...
	public String form(Role role, Model model) {
		if (role.getOffice()==null){
			role.setOffice(UserUtil.getUser().getOffice());
		}
		model.addAttribute("role", role);
		model.addAttribute("menuList", systemService.findAllMenu());
		model.addAttribute("officeList", officeService.findAll());
		return "modules/admin/roleForm";
	}
	
	@RequiresPermissions("sys:role:edit")
	@RequestMapping(value = "save")
	public String save(Role role, Model model, RedirectAttributes redirectAttributes) {
		if(!UserUtil.getUser().isAdmin()&&role.getSysData().equals(Global.YES)){
			addMessage(redirectAttributes, "越权操作，只有超级管理员才能修改此数据！");
			return "redirect:" + adminPath + "/admin/role/?repage";
		}
...
////		}else if (UserUtil.getUser().getRoleIdList().contains(id)){
...
//		}
	...
	public String assign(Role role, Model model) {
		...
		return "modules/admin/roleAssign";
	}
	...
	public String selectUserToRole(Role role, Model model) {
		...
		model.addAttribute("officeList", officeService.findAll());
		return "modules/admin/selectUserToRole";
	}
	...
	public String outrole(String userId, String roleId, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/admin/role/assign?id="+roleId;
		}
		...
		return "redirect:" + adminPath + "/admin/role/assign?id="+role.getId();
	}
