...
import org.thrive.site.modules.admin.security.FormAuthenticationFilter;
import org.thrive.site.core.config.Global;
import org.thrive.site.core.controller.BaseController;
import org.thrive.site.core.security.Principal;
import org.thrive.site.core.security.shiro.session.SessionDAO;
import org.thrive.site.core.servlet.ValidateCodeServlet;
import org.thrive.site.core.util.CacheUtil;
import org.thrive.site.core.util.CookieUtil;
import org.thrive.site.core.util.IdGen;
...
//		// 默认页签模式
//		String tabmode = CookieUtil.getCookie(request, "tabmode");
//		if (tabmode == null){
//			CookieUtil.setCookie(response, "tabmode", "1");
//		}
		...
		if (Global.TRUE.equals(Global.getConfig("notAllowRefreshIndex"))){
			CookieUtil.setCookie(response, "LOGINED", "false");
		}
...
//		String view;
//		view = "/WEB-INF/views/modules/admin/sysLogin.jsp";
//		view = "classpath:";
//		view += "jar:file:/D:/GitHub/jeesite/src/main/webapp/WEB-INF/lib/jeesite.jar!";
//		view += "/"+getClass().getName().replaceAll("\\.", "/").replace(getClass().getSimpleName(), "")+"view/sysLogin";
//		view += ".jsp";
		return "modules/admin/sysLogin";
	}
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		if (Global.TRUE.equals(Global.getConfig("notAllowRefreshIndex"))){
			...
			if (StringUtil.isBlank(logined) || "false".equals(logined)){
				CookieUtil.setCookie(response, "LOGINED", "true");
		...
		if (principal.isMobileLogin()){
			...
			if (request.getParameter("index") != null){
				return "modules/admin/sysIndex";
			}
			return "redirect:" + adminPath + "/login";
		}
		
//		// 登录成功后，获取上次登录的当前站点ID
//		UserUtil.putCache("siteId", StringUtil.toLong(CookieUtil.getCookie(request, "siteId")));
...
////			//UserUtil.getSession().setAttribute("a", "a");
